...
def f(x):
    ...
    #obj = 20 + x1**2 + x2**2 - 10*math.cos(2.0*3.1415*x1) - 10*math.cos(2.0*3.1415*x2)
    #obj = oc.costFunc_perm(x)
    #obj = cfp.cf(x)
    return obj
...
# Start location
#x_start = [0.8, -0.5]
x_start = [random.uniform(-5,5), random.uniform(-5,5)]
#print x_start
